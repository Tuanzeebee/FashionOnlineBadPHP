...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="test1">
                        ...
                        <li><a href="donam.php" title="Hướng dẫn chọn size">Đồ Nam</a></li>
                    </ul>
                    <div class="clf"></div>
                </div>
            </div>
    ...
    <div class="text text-dark text-left mt-2">
        <h1 class="ml-2 text-center">Đồ Nam</h1>
    </div>
        ...
        <div class="">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='information.php?type=products&id=" . htmlspecialchars($row['id']) . "' title='" . htmlspecialchars($row['name']) . "'>";
                    echo "<img src='api/images/products/" . htmlspecialchars($row['image']) . "' alt='" . htmlspecialchars($row['name']) . "' />";
                    ...
                    echo "<a href='add_to_cart.php?type=products&id=" . htmlspecialchars($row['id']) . "' class='button'>Thêm vào giỏ hàng</a>";
