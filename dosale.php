...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="test1">
                        ...
                        <li><a href="dosale.php" title="Hướng dẫn chọn size">Hàng Giảm Giá</a></li>
                    </ul>
                    <div class="clf"></div>
                </div>
            </div>
    ...
    <div class="text text-dark text-left mt-2">
        <h1 class="ml-2 text-center">Hàng Giảm Giá</h1>
    </div>
        ...
        <div class="">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='information.php?type=dosale&id=" . htmlspecialchars($row['id']) . "' title='" . htmlspecialchars($row['name']) . "'>";
                    echo "<img src='api/images/dosale/" . htmlspecialchars($row['image']) . "' alt='" . htmlspecialchars($row['name']) . "' />";
                    ...
                    echo "<a href='add_to_cart.php?type=dosale&id=" . htmlspecialchars($row['id']) . "' class='button'>Thêm vào giỏ hàng</a>";
